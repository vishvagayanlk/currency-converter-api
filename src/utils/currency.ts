...
type CurrencyCodeType = (typeof supportedCurrencies)[number]["code"];
const isValidCurrency = (currencyCode: CurrencyCodeType) => {
  return supportedCurrencies.find((currency) => currency.code === currencyCode);
};
